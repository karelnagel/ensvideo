...
export type EnsQueryVariables = Exact<{
  name?: InputMaybe<Scalars['String']>;
}>;
 ...
 * __useEnsQuery__
 *
 * To run a query within a React component, call `useEnsQuery` and pass it any options that fit your needs.
 * When your component renders, `useEnsQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useEnsQuery({
 *   variables: {
 *      name: // value for 'name'
 *   },
 * });
 */
export function useEnsQuery(baseOptions?: Apollo.QueryHookOptions<EnsQuery, EnsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<EnsQuery, EnsQueryVariables>(EnsDocument, options);
      }
export function useEnsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<EnsQuery, EnsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<EnsQuery, EnsQueryVariables>(EnsDocument, options);
        }
